...
Status note (2026-03-01): projects baseline is implemented with keyPrefix uniqueness, client-scoped project create/list/status-update/delete, and project-linked task APIs (`/api/projects/:id/tasks`) plus basic `/app/projects` UI.
