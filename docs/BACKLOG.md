...
Status note (2026-03-01): services CRUD baseline is implemented; renewal/task-due/inactivity cron + Notification Center baseline are now wired with snooze/mark-handled actions.
